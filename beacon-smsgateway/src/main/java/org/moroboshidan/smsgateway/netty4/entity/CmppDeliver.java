    ...
    public CmppDeliver(byte[] data) {
        ...
        try {
            if (null != data && data.length > 0) {
                ...
                dis.read(msgid_b);
                this.Msg_Id = msgid_b;
                this.Dest_Id = MsgUtil.readString(dis, 21, null);// 21bit
                this.Service_Id = MsgUtil.readString(dis, 10, null);
                this.TP_pid = dis.readByte();
                this.TP_udhi = dis.readByte();
                this.Msg_Fmt = dis.readByte();
                // 源终端MSISDN号码（状态报告时填为CMPP_SUBMIT消息的目的终端号码）
                this.Src_terminal_Id = MsgUtil.readString(dis, 21, this.Msg_Fmt == 8 ? "UTF-16BE" : "gb2312");
                ...
                if (this.Registered_Delivery == 1) {
                    ...
                    this.Msg_Id_DELIVRD = MsgUtil.bytesToLong(Msg_Id_DELIVRD_B);
                    this.Msg_Id_DELIVRD = Math.abs(this.Msg_Id_DELIVRD);
                    this.Stat = MsgUtil.readString(disd, 7, this.Msg_Fmt == 8 ? "UTF-16BE" : "gb2312");
                    this.Submit_time = MsgUtil.readString(disd, 10, this.Msg_Fmt == 8 ? "UTF-16BE" : "gb2312");
                    this.Done_time = MsgUtil.readString(disd, 10, this.Msg_Fmt == 8 ? "UTF-16BE" : "gb2312");
                    this.Dest_terminal_Id = MsgUtil.readString(disd, 21, this.Msg_Fmt == 8 ? "UTF-16BE" : "gb2312");
